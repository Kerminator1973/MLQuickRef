...
2. Установить компилятор gcc, необходимый для сборки CUDA:
...
4. Установить СUDA из официального репозитария Nvidia. Драйверы NVDIA добавятся автоматически как зависимости:
...
7. Проверить, что ОС видит видеокарту и утилиты доступны, можно следующими командами:
