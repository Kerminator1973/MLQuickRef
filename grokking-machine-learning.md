...
- **Кластеризация К-средних**. Алгоритм группирует точки, выбирая некоторые случайные центы масс и перемещая их все ближе и ближе к точкам, пока они не окажутся в нужных местах
...
- **Пространственная кластеризация на основе плотности (DBSCAN)**, Это аглогитм начинает группировать точки в местах с высокой плотностью, помечая изолированные точки как шум
- **Гауссовы модели смешения**. Алгоримт не присвает точки одному кластеру, а присваивает доли точки каждому из существующих кластеров
