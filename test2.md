...
## Пример использования библиотеки Seaborn для визуализации данных

Загрузка данных из dataset-а:
...
Визуализация осуществляется с помощью вызова метода pairlot(). Например:
