...
- Регрессия - прогнозировать значения для объектов по некоторому набору свойств (например, доход человека по его возрасту, профессии, семейному положению, и т.д.)
